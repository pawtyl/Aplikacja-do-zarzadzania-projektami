...
namespace aspnet.Controllers
{
    public class TaskController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TaskId,ProjectId,Name,Description,DueDate")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaskId,ProjectId,Name,Description,DueDate")] Task task)
        {
            if (id != task.TaskId)
            {
                return NotFound();
